...
<div class="container">
    <div class="header">
        ...
        <a href="${pageContext.request.contextPath}/admin/inscriptions?action=add" class="btn-add">
        ...
        <table>
            ...
            <c:forEach var="inscription" items="${inscriptions}">
                <tr>
                    ...
                    <td>
                            ${inscription.apprenant != null ?
                                    inscription.apprenant.nom.concat(' ').concat(inscription.apprenant.prenom) :
                                    'N/A'}
                    </td>
                    <td>${inscription.apprenant != null ? inscription.apprenant.email : 'N/A'}</td>
                    <td>
                            ${inscription.formation != null ? inscription.formation.titre : 'N/A'}
                    </td>
                    ...
                    <td>
                        <a href="${pageContext.request.contextPath}/admin/inscriptions?action=delete&id=${inscription.id}"
                           class="btn-delete"
